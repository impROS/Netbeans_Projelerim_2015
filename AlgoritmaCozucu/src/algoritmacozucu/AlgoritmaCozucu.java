...
package algoritmacozucu;

import java.util.Arrays;
import java.util.Scanner;
public class AlgoritmaCozucu {
...
if(kontrol){
	...
	kontrol =algo.kareToplamAlg(dizi);
yaz("Kare+Toplama algoritması = "+kontrol);
	if(kontrol){
		yaz("**************************************************");
		yaz("Algoritma Bulundu!Dizi Algoritması = n kare+"+algo.fark);
		yaz("**************************************************");
}
	diziSifirla(diziyedek,dizi);
	ayrac();
	...
	kontrol =algo.kubToplamAlg(dizi);
yaz("Kub+Toplama algoritması = "+kontrol);
	if(kontrol){
		yaz("**************************************************");
		yaz("Algoritma Bulundu!Dizi Algoritması = n kub+"+algo.fark);
		yaz("**************************************************");
}
	diziSifirla(diziyedek,dizi);
	ayrac();
