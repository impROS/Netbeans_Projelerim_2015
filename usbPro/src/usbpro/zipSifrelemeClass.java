...
public class zipSifrelemeClass {
     ...
     * archive
     */
    public  void encryptZip(String srcFile, String destfile,
        ...
        // get privateKey
        zipSifrelemeClass.privateKey = kp.getPrivate();
        // get publicKey
        zipSifrelemeClass.publicKey = kp.getPublic();
        File f = new File(keyfile);
        f.createNewFile();
        FileOutputStream fos = new FileOutputStream(f);
        ObjectOutputStream dos = new ObjectOutputStream(fos);
        dos.writeObject(zipSifrelemeClass.publicKey);
