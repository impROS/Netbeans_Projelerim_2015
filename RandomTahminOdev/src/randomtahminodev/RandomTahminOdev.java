...
System.out.println("Lutfen 0 dan 10 a kadar bir tahmin giriniz");//kullanıcıyı bir deger girecegi konusunda bilgilendirdik
 tahmin = giris.nextInt();//tahmin adlı degerimizi,klavyeden girilecek olan bir integer degerine esitledik
     ...
     {
     System.out.println("Bilemediniz..Lutfen daha asagida bir deger giriniz");//kullanicidan daha buyuk bir deger istedik
     }
